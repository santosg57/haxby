...
print '---------------------- Dataset basics and concepts ----------------'
...
print 'shape: ', one_ds.shape

import numpy as np
m_ds = Dataset(np.random.random((3, 4, 2, 3)))
print 'shape: ', m_ds.shape

print 'nfeatures: ', m_ds.nfeatures

print '---------------------------- Atributes ---------------------' 

ds.sa['some_attr'] = [ 0., 1, 1, 3 ]
print 'keys: ', ds.sa.keys()
