...
mask_fname = os.path.join("/misc/arwen/azalea/PPI/TPJ_previous/MasksSubjects/PH101_Cor01_left.nii.gz")
mask_brain = os.path.join("/misc/arwen/azalea/niigui/PH101_410/PH101_Cor01.feat/mask.nii.gz")

def Lee_Sujeto(num):
   data_path='/misc/charcot/jhevia/azalea_pymvpa/data' + str(1) + '/Azalea2017/'
   mask_fname = os.path.join("/misc/arwen/azalea/PPI/TPJ_previous/MasksSubjects/PH101_Cor01_left.nii.gz")
   mask_brain = os.path.join("/home/inb/santosg/TUTO/tutorial_data/data/haxby2001/sub001/masks/orig/brain.nii.gz")
   ...
   for run_id in dhandle.get_task_bold_run_ids(task)[subj]:
        ...
        run_ds = dhandle.get_bold_run_dataset(subj, task, run_id,
                                           chunks=run_id -1,
                                           add_fa = {'vt_thr_glm' : mask_fname},
                                           mask=mask_brain)
        # convert event info into a sample attribute and assign as 'targets'
        run_ds.sa['targets'] = events2sample_attr(
                 run_events, run_ds.sa.time_coords, noinfolabel='rest')
#     run_ds.fa['vt_thr_glm'] = mask_fname
...
dataset = dataset[np.array([l in ['COOPERADOR', 'NCOOPERADOR']
...
plot_args = {
    'background' : os.path.join('/home/inb/santosg/TUTO/tutorial_data/data/haxby2001/sub001/anatomy', 'highres001.nii.gz'),
    'background_mask' : mask_brain,
